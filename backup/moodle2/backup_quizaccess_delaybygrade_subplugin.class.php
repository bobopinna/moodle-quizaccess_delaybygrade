...
/**
 * Provides the information to backup the delaybygrade quiz access plugin.
 *
 * If this plugin is required, a <quizaccess_delaybygrade> tag
 ...
 * @license    http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class backup_quizaccess_delaybygrade_subplugin extends backup_mod_quiz_access_subplugin {
    ...
    protected function define_quiz_subplugin_structure() {
        ...
        $subplugintablesettings = new backup_nested_element('quizaccess_delaybygrade', null, ['enabled']);
        $subpluginwrapper->add_child($subplugintablesettings);

        $subplugintablesettings->set_source_table('quizaccess_delaybygrade', ['quizid' => backup::VAR_ACTIVITYID]);
